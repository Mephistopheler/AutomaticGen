...
def main() -> None:
    ...
    parser.add_argument('--language', default='unknown', help='Language tag for language-aware prompts, e.g. en or ru')
    ...
    if args.input_jsonl:
        ...
        items.append({'context': args.context, 'answer_text': args.answer, 'language': args.language})
